import type{ tarea } from "../elementoTarea/Tarea.ts";
import { Imprimir } from "../Funciones_puras/imprimir.ts";
...
export function recibirDato(Dificultades:any):tarea{
    ...
    while(titulo==""){//verifica que el titulo no este vacio
        Imprimir("El titulo no puede estar vacio.");
